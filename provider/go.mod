...
replace (
	github.com/filipowm/terraform-provider-unifi/shim => ./shim
...
require (
	github.com/filipowm/terraform-provider-unifi/shim v0.0.0
...
require (
	...
	github.com/filipowm/terraform-provider-unifi v1.1.0 // indirect
