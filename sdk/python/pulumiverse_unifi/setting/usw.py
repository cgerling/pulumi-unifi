...
class UswArgs:
    ...
    def dhcp_snoop(self) -> pulumi.Input[_builtins.bool]:
        """
    ...
    @dhcp_snoop.setter
    def dhcp_snoop(self, value: pulumi.Input[_builtins.bool]):
...
@pulumi.type_token("unifi:setting/usw:Usw")
class Usw(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(UswArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = UswArgs.__new__(UswArgs)

            if dhcp_snoop is None and not opts.urn:
                raise TypeError("Missing required property 'dhcp_snoop'")
            __props__.__dict__["dhcp_snoop"] = dhcp_snoop
            __props__.__dict__["site"] = site
        super(Usw, __self__).__init__(
            'unifi:setting/usw:Usw',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__ = _UswState.__new__(_UswState)

        __props__.__dict__["dhcp_snoop"] = dhcp_snoop
        __props__.__dict__["site"] = site
        return Usw(resource_name, opts=opts, __props__=__props__)

    @_builtins.property
    @pulumi.getter(name="dhcpSnoop")
    def dhcp_snoop(self) -> pulumi.Output[_builtins.bool]:
        """
        Whether DHCP snooping is enabled. DHCP snooping is a security feature that filters untrusted DHCP messages and builds a binding database of valid hosts.
        """
        return pulumi.get(self, "dhcp_snoop")
