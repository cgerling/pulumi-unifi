...
export class ApGroup extends pulumi.CustomResource {
    ...
    /**
     * Set of AP device MAC addresses to include in this AP group. MAC addresses are case-insensitive and may use `:` or `-` separators; they are normalized to lowercase, colon-separated form.
     */
